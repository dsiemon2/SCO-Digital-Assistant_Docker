  ...
  await prisma.businessConfig.create({
    data: {
      ...
      hoursJson: JSON.stringify({
        'Event Days': '11:00 AM - 3:00 PM',
        'VIP Early Entry': '10:30 AM'
      }),
      address: 'Visit soupcookoff.com for event locations - Harrisburg (Best Western Premier) and Carlisle (Expo Center)',
