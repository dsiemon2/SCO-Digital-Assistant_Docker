# Roadmap - Soup Cookoff Digital Voice Assistant
...
- Past winners information
- Chef registration information
...
- [x] Credit card ticket purchasing over phone
- [x] Order confirmation via SMS/email
- Refund handling
- Payment retry logic
...
- Multi-event support
- Sponsorship inquiry capture
- Chef registration assistance
...
- [x] Automated sponsor follow-ups
- Post-event winner announcements
...
- Increased sponsor conversion rate
...
### Success Metrics
- 30%+ increase in repeat attendees
...
- [ ] Proactive outbound calling (event reminders)
- [ ] AI-generated post-call summaries
- [ ] British/regional accent support (requires ElevenLabs or PlayHT)

### Event Enhancements
- [ ] Live voting results during event
- [ ] Chef spotlight announcements
- [ ] Real-time ticket availability updates
- [ ] Weather-based messaging
- [ ] Parking/directions integration

### Community Features
- [ ] Recipe sharing from winners
- [ ] Chef interview recordings
- [ ] Event photo gallery voice tour
- [ ] Donor recognition announcements
- [ ] Volunteer appreciation calls
...
| Phase 2 (Payments) | 1-2 weeks | Before next event |
| Phase 3 (Analytics) | 2 weeks | After first event |
| Phase 4 (Multi-Channel) | 3-4 weeks | Q2 |
| Phase 5 (Integrations) | 4-6 weeks | Q3 |
| Phase 6 (Production) | Ongoing | Q4 |

*Timeline is flexible and depends on event schedule and resource availability*
