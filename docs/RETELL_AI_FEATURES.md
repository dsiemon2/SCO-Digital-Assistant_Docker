...
This document analyzes Retell AI's features and their potential applicability to our Soup Cookoff Digital Voice Assistant.
...
**Use case:**
Check real-time ticket availability, process Stripe payments, look up sponsor information, create calendar events.
...
**Use case:**
Route conversation differently based on context: "If ticket_type == 'VIP' then describe VIP benefits, else describe GA benefits"

---

## Feature Applicability to Soup Cookoff Assistant
...
#### 1. SMS Notifications
**Why:** Callers who purchase tickets need confirmation they can reference. Verbal confirmation codes are easily forgotten or misheard.

**Implementation ideas:**
- Send ticket confirmation with code after purchase
- Send event reminder 24 hours before
- Send link to digital tickets
- Send receipt/invoice link

**Example flow:**
```
Caller: "I'd like to buy 2 VIP tickets for Harrisburg"
AI: [processes payment]
AI: "Great! I've sent a confirmation text to your phone with your ticket details and a link to download them."
[SMS sent: "Your Soup Cookoff tickets: 2x VIP for Harrisburg Oct 19. Confirmation: SCO-ABC123. Download: link"]
```
...
- Slack notifications for sponsorship inquiries
...
**Why:** More reliable data capture for ticket purchases and sponsor inquiries.
...
- `ticket_type` (GA/VIP)
- `ticket_quantity`
- `event_preference` (Carlisle/Harrisburg)
- `company_name` (for sponsors)
- `sponsorship_tier`
...
- Ticket Sales Agent (purchase flow)
- Sponsor Agent (B2B inquiries)
- Event Info Agent (FAQ responses)
...
1. [ ] Implement SMS confirmations using Twilio SMS API
